...
RotationTweener::RotationTweener(Entity* entity, float target, float duration, Tweening::Easings easing) :
...
RotationTweener::RotationTweener(Entity* entity, float target, float duration, void(*onComplete)(), Tweening::Easings easing) :
